class Zip3mf
  ...
  RELATIONSHIP_TYPES = {
    'http://schemas.microsoft.com/3dmanufacturing/2013/01/3dmodel' => 'Model3mf',
    'http://schemas.openxmlformats.org/package/2006/relationships/metadata/thumbnail' => 'Thumbnail3mf' #,
    # 'http://schemas.microsoft.com/3dmanufacturing/2013/01/3dtexture' => 'Texture3d'
  }
                ...
                l.context rel[:target] do |l|
                  ...
                  if relationship_file
                    ...
                    if relationship_type.nil?
                      ...
                      @relationship_elements << {rel_id: rel[:id], model: Object.const_get(relationship_type).parse(relationship_file, @relationships)}
                    end
                  else
